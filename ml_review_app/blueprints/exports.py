...
PUBLICATION_FILE_KEYS = (
    ...
    "ai_full_text_screening_results", "human_full_text_decisions", "full_text_screening_results",
...
def publication_bundle(project_id: str):
    ...
    with zipfile.ZipFile(buffer, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        audit_manifest = {
            ...
            "abstract_auto_review_rows": manifest.get("abstract_auto_review_rows", 0),
            ...
            "full_text_auto_review_rows": manifest.get("full_text_auto_review_rows", 0),
            "full_text_ai_screening_rows": manifest.get("full_text_ai_screening_rows", 0),
